	...
	$(function() {
     ...
     <div class="slider_container">
		<div class="flexslider">
	      <ul class="slides">
	    	<li>
	    		<a href="#"><img src="images/slider/img5.jpg" width="900px" height="400px" alt="" title=""/></a>
	    	...
	    	<li>
	    		<a href="#"><img src="images/slider/img3.jpg" width="900px" height="400px" alt="" title=""/></a>
	    		<div class="flex-caption">
	    	...
	    	<li>
	    		<a href="#"><img src="images/slider/img4.jpg" width="900px" height="400px" alt="" title=""/></a>
	    		<div class="flex-caption">
                     <div class="caption_title_line"><h2>Controled By Admin</h2><p>Everying is managed and controled by administrator</p></div>
                </div>
	    	</li>
	    	<li>
	    		<a href="#"><img src="images/slider/img7.jpg" width="900px" height="400px" alt="" title=""/></a>
	    		<div class="flex-caption">
